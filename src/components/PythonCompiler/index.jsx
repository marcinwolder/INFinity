  ...
  return (
    <div>
      ...
      <div className="relative">
        <div
          ref={loaderDiv}
          className="absolute z-10 flex h-full w-full items-center justify-center bg-neutral-700 opacity-70"
        >
      ...
      >
        <button
          ...
          className={classNames(
            "absolute right-2 top-2 z-10 flex items-center gap-1 bg-black pl-2 text-white",
        ...
        <button
          disabled={disabled}
          className={classNames(
            "absolute right-2 top-9 z-10 flex items-center gap-1 bg-black pl-2 text-white",
        ...
        <button
          ...
          disabled={disabled}
          className={classNames(
            "absolute right-2 top-16 z-10 flex items-center gap-1 bg-black pl-2 text-white",
        ...
        <button
          disabled={disabled}
          className={classNames(
            "absolute bottom-2 right-2 z-10 flex items-center gap-1 bg-black pl-2 text-white",
